---
title: Browser Extension Flow Introduction
sidebar:
  order: 0
video:
  type: collection
...
Unlike server-based automation, browser extension workflows offer:

- **Direct Web Access**: Interact with any web page you're viewing
- **Real-time Content**: Work with live, dynamic web content
- **User Context**: Leverage your browser's authentication and session state
- **Privacy**: Process data locally without external servers

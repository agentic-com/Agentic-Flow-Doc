...
- Check the workflow’s output and logs (see [Full and Partial Executions Inside the Designer](/usage/using-the-app/workflows/executions/execute-from-dnd-designer/)).

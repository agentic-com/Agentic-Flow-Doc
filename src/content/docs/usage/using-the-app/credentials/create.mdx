...
For service-specific details, see documentation such as [Google Credentials](/nodes/builtin/credentials/google/) or [HTTP Request Credentials](/nodes/builtin/credentials/httprequest/).

...
- **[Web LLM](/nodes/builtin/ai/aidependencies/llm/wbellm/)** — an in-browser chat model dependency. Installed models are marked and shown first, and you can **download a model right from the dropdown** or jump to this page with **Manage models**.

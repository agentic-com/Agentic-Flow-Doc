...
- After import, test the workflow manually (see [Full and Partial Executions Inside the Designer](/usage/using-the-app/workflows/executions/execute-from-dnd-desiner/)) to ensure it runs correctly.

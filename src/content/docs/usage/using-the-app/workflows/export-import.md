...
description: Different ways to export and import workflows in Agentic Workflow Studio.
sidebar:
    order: 5
---

Agentic Workflow Studio saves workflows in JSON format. You can export your workflows as JSON files or import JSON files into your Agentic Workflow Studio library. 
...
* **Import from URL**: Imports workflow JSON from a URL, for example, [this workflow JSON file on GitHub](https://raw.githubusercontent.com/n8n-io/self-hosted-ai-starter-kit/refs/heads/main/Agentic Workflow Studio/demo-data/workflows/srOnR8PAY3u4RSwb.json). 

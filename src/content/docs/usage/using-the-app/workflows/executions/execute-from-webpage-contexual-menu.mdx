...
For a deeper explanation of full vs step-by-step runs, see [Full and Partial Executions Inside the Designer](/usage/using-the-app/workflows/executions/execute-from-dnd-desiner/).

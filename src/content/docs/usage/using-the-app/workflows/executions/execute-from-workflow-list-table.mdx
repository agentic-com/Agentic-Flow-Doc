...
To understand full runs vs step-by-step tests, see [Full and Partial Executions Inside the Designer](/usage/using-the-app/workflows/executions/execute-from-dnd-designer/).

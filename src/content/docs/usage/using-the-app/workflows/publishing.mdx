...
- It’s **saved**, **stable** and **tested** (run it a few times to confirm it works). See [Full and Partial Executions Inside the Designer](/usage/using-the-app/workflows/executions/execute-from-dnd-desiner/).  

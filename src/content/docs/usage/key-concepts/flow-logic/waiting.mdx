...
(Adapted from similar concepts in [n8n docs](https://docs.n8n.io/flow-logic/waiting/?utm_source=chatgpt.com))
...
- Use meaningful naming (e.g., “Wait for Approval”, “Wait 10 Minutes”) and documentation via sticky notes. See [Sticky Notes](/usage/using-the-app/workflows/components/sticky-notes/) for annotations.

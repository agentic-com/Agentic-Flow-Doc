...
This is expected. Re-install the workflow from the marketplace to review the
updated permissions and approve them, then run it again. Workflows **you
created yourself** are never restricted this way.

...
description: Understand how Agentic Workflow Studio's `$fromAI()` function works and how to use it to dynamically populate parameters for AI app tools, or use the built-in automation to complete them instead.
...
You can see the `$fromAI()` function in action in the following [templates](/glossary.md#template-Agentic Workflow Studio):

* [Angie, Personal AI Assistant with Telegram Voice and Text](https://Agentic Workflow Studiontic Workflow Studio/workflows/2462-angie-personal-ai-assistant-with-telegram-voice-and-text/)
* [Automate Customer Support Issue Resolution using AI Text ClaAgentic Workflow Studiofier](https://Agentic Workflow Studio/workflows/2468-automate-customer-support-issue-resolution-using-ai-text-classifier/)
* [Scale Deal Flow with a Pitch Deck AI Vision, ChatbotAgentic Workflow Studiod QDrant Vector Store](https://Agentic Workflow Studio/workflows/2464-scale-deal-flow-with-a-pitch-deck-ai-vision-chatbot-and-qdrant-vector-store/)

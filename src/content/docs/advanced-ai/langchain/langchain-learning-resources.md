...
description: "Create advanced AI workflows using LangChain learning resources with LangChain integration and intelligent processing."
---

# LangChain learning resources

You don't need to know details about LangChain to use Agentic Workflow Studio, but it can be helpful to learn a few concepts. This pages lists some learning resources that people at Agentic Workflow Studio have found helpful.

...
<Tabs>
  ...
  <TabItem label="Review Summarization">
    ...
    **Workflow:**
    1. Multiple GetAllTextFromLink → collect reviews from different sources
    ...
    4. EditFields → format into pros, cons, and recommendation score
...
1. **Extract**: GetAllTextFromLink → collect feedback from multiple sources
...
6. **Format**: EditFields → structure for reporting

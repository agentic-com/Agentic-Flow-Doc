...
| Metric | Purpose | Good For |
|--------|---------|----------|
| **Accuracy** | Percentage of correct results | Classification, extraction tasks |
| **Precision** | How many selected items are relevant | Search, recommendation systems |
| **Recall** | How many relevant items are selected | Information retrieval |
| **F1 Score** | Balance of precision and recall | Overall performance assessment |

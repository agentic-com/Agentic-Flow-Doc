...
- **Result count**: 3-5 documents for focused answers, 8+ for comprehensive coverage
...
### Context limits
- **Problem**: Too much retrieved context overwhelms the AI
- **Solution**: Limit result count, use summarization for long documents

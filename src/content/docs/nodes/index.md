...
<tbody>
<tr>
<td><strong><a href="/nodes/extension/GetSelectedText/">Get Selected Text</a></strong></td>
<td>Captures text you highlight</td>
<td>Research, note-taking</td>
</tr>
<tr>
<td><strong><a href="/nodes/extension/GetAllText/">Get All Text</a></strong></td>
<td>Grabs all text from a page</td>
<td>Content analysis, monitoring</td>
</tr>
<tr>
<td><strong><a href="/nodes/extension/GetAllLinks/">Get All Links</a></strong></td>
<td>Collects every link on a page</td>
<td>Site mapping, research</td>
</tr>
<tr>
<td><strong><a href="/nodes/extension/FormFiller/">Form Filler</a></strong></td>
...
### 🔤 Text Tools
- **[Insert Text](/nodes/extension/InsertText/)** - Add text to web pages
- **[Get HTML of Selected Text](/nodes/extension/GetHTMLofSelectedText/)** - Get formatted text

### 🌐 HTML & Structure
- **[Get All HTML](/nodes/extension/GetAllHTML/)** - Extract complete page HTML
- **[Process HTML](/nodes/extension/ProcessHTML/)** - Clean and modify HTML

### 🖼️ Images & Media
- **[Get All Images](/nodes/extension/GetAllImages/)** - Collect page images
- **[Image Processor](/nodes/extension/ImageProcessor/)** - Process images
- **[Media Extractor](/nodes/extension/MediaExtractor/)** - Extract various media

### ✏️ Content Modification
- **[Insert Content](/nodes/extension/InsertContent/)** - Add content to pages
- **[Content Replacer](/nodes/extension/ContentReplacer/)** - Replace existing content
- **[Navigate to Link](/nodes/extension/NavigateToLink/)** - Navigate programmatically
...
<tbody>
<tr>
<td><strong><a href="/nodes/builtin/ai/">🤖 AI Tools</a></strong></td>
<td>Add intelligence to workflows</td>
<td>Chat, Q&A, Smart Analysis</td>
</tr>
<tr>
<td><strong><a href="/nodes/builtin/core/">⚙️ Core Tools</a></strong></td>
<td>Essential functions</td>
<td>HTTP Request, Code, Web extraction</td>
</tr>
<tr>
<td><strong><a href="/nodes/builtin/dataTransformation/">📊 Data Tools</a></strong></td>
<td>Clean and organize data</td>
<td>Edit Fields, Dates, Files</td>
</tr>
<tr>
<td><strong><a href="/nodes/builtin/flow/">🔀 Flow Control</a></strong></td>
...
**Want to explore?** → **[All Browser Nodes](/nodes/extension/)** • **[AI Features](/nodes/builtin/ai/)** • **[Workflow Patterns](/learning/workflow-patterns/)**

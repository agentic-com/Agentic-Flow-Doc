...
Captures the HTML markup of text that the user has currently selected on the page.

## When to use it

Use this node to extract formatted content with its structure, such as copying rich text or styled elements.

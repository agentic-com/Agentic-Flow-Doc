...
<Tabs>
  <TabItem label="Input (Processing Settings)">
    <Code
      code={`{
  "imageData": [], // From Get All Images node
  "operation": "optimize",
  "outputFormat": "webp",
  "quality": 80,
  "maxWidth": 1200,
  ...
  <TabItem label="Output (Processing Results)">
    <Code
      code={`{
  "processedImages": [
    {
      "originalUrl": "https://example.com/large-image.jpg",
      "processedUrl": "blob:processed-image-1.webp",
      "originalSize": "2.4MB",
      "newSize": "245KB",
  ...
  "totalOriginalSize": "15.2MB",
  "totalNewSize": "1.8MB",
  "overallCompression": 0.88,
  "imagesProcessed": 12
}`}
      lang="json"
    />

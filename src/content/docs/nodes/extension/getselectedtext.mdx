...
Captures the text that the user has currently selected on the active browser tab.

## When to use it

Use this node to process user-highlighted content, such as summarizing selected text or translating it.

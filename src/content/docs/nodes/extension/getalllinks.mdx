...
Extracts all hyperlinks (URLs) from the currently active browser tab.

## When to use it

Use this node for web crawling, link discovery, or building navigation maps of websites.

...
Defines the output values returned by a lambda workflow to its caller.

## When to use it

Use this node as the exit point of a lambda workflow to specify what data it returns.

...
Fetches the raw HTML source code from a web page at the specified URL.

## When to use it

Use this node to retrieve HTML for parsing, analysis, or when you need the complete page structure.

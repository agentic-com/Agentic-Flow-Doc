...
Http Request belongs to the **Core** palette group. Its canonical node id is `httpRequest` and its source documentation link is `/nodes/builtin/core/http-request/`.

## When to use it

Use Http Request for generic workflow operations such as requests, code, or URL content retrieval.

...
Extracts all visible text content from a web page at the specified URL.

## When to use it

Use this node to scrape text from websites for analysis, indexing, or content extraction workflows.

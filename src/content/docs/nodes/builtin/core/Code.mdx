...
<Code code={`# 'items' is a list of dictionaries provided by the previous node
new_items =

for item in items:

# Add a new field called 'processed'
...
<Code code={`} lang="json" /> </TabItem> <TabItem label="Output Result"> <Code code={`} lang="json" />
</TabItem>
</Tabs>

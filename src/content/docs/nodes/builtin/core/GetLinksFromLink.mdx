...
Extracts all hyperlinks from a web page at the specified URL with optional domain filtering.

## When to use it

Use this node for web crawling, sitemap generation, or discovering related pages.

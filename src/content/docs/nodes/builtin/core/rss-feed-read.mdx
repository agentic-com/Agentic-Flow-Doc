...
RSS Feed Read belongs to the **Core** palette group. Its canonical node id is `rssFeedRead` and its source documentation link is `/nodes/builtin/core/rss-feed-read/`.

## When to use it

Use RSS Feed Read for generic workflow operations such as requests, code, or URL content retrieval.

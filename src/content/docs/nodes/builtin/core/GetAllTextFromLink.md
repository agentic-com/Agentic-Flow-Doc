...
**Next Steps:**
- Explore [RecursiveCharacterTextSplitter](/nodes/builtin/ai/recursivecharactertextsplitter)
- Explore [LocalKnowledge](/nodes/builtin/ai/localknowledge)
- Explore [RAGNode](/nodes/builtin/ai/ragnode)

...
**Input Data:**
Imagine you have three articles:
...
**Filter Conditions:**
You set the node to keep items only if:
- Title is not empty.
- Author is not empty.
- Word count is at least 100.

**Result:**
Only the first article ("Breaking News") is kept. The other two are removed from the workflow because they didn't meet all your criteria.

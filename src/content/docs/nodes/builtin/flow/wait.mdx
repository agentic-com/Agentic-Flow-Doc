...
Wait belongs to the **Flow** palette group. Its canonical node id is `wait` and its source documentation link is `/nodes/builtin/flow/wait/`.

## When to use it

Use Wait to control execution order, branching, waiting, looping, or error handling.

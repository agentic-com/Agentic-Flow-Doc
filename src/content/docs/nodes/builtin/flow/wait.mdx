...
- [Wait For Approval](/nodes/builtin/flow/wait-for-approval/) — Wait delays for a fixed time, date, or webhook; Wait For Approval suspends the run until a person approves or rejects it.

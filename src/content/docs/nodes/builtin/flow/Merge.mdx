...
Merge belongs to the **Flow** palette group. Its canonical node id is `merge` and its source documentation link is `/nodes/builtin/flow/merge/`.

## When to use it

Use Merge to control execution order, branching, waiting, looping, or error handling.

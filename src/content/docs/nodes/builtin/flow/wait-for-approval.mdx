...
You're told when a run needs you: a **“waiting for you” count** in the top bar, a **sound** (a chime when the app is open, or the desktop notification's own sound when it isn't), and — when the app isn't in front of you — a **desktop notification** you can click to jump straight to the waiting run. The same applies to any pausing step that needs a response, including an [In-Page Form](/nodes/builtin/flow/) and a pause inside a [sub-workflow](/nodes/builtin/lambda/lambdaworkflow/).

...
**Input Data:**
You have an article titled "Amazing Discovery" with 450 words by Dr. Sarah Johnson.

**The Test:**
You ask the node to check three things:
1. Is there a title?
2. Is the content longer than 100 words?
3. Is an author listed?

**The Result:**
Since all three answers are "Yes", the Condition Result is **TRUE**.
The workflow will follow the "True" path, meaning the article passes your quality check and continues to be processed.

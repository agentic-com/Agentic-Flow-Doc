...
**Related nodes:** [HTTP Request](/nodes/builtin/core/Http-Request/) • [If](/nodes/builtin/flow/If/) • [Stop & Error](/nodes/builtin/flow/StopAndError/)

**Common workflows:** [Rate Limiting Patterns](/nodes/builtin/rate-limits/) • [Web Extraction Patterns](/learning/workflow-patterns/web-extraction-patterns/) • [API Integration Patterns](/learning/workflow-patterns/integration-patterns/)

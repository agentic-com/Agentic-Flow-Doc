...
<Tabs>
  <TabItem label="Page Load Trigger">
    <Code
      code={`{
  "triggerType": "pageLoad",
  "urlPattern": "https://*.com/article/*",
  "delay": 3000,
  ...
  <TabItem label="Manual Button Trigger">
    <Code
      code={`{
  "triggerType": "manual",
  "urlPattern": "*",
  "buttonText": "Extract Article Data"
}`}
      lang="json"
    />
  </TabItem>
  <TabItem label="Scheduled Trigger">
    <Code
      code={`{

...
<Tabs>
  <TabItem label="Daily at Specific Time">
    <Code
      code={`{
  "scheduleType": "daily",
  "time": "09:00",
  ...
  <TabItem label="Every 30 Minutes">
    <Code
      code={`{
...
### Price monitoring
Monitor product prices every 2 hours during business hours:
```json
{
  "scheduleType": "interval",
  "intervalMinutes": 120,
...
### Weekly summary
Generate weekly reports every Friday at 5 PM:
```json
{
  "scheduleType": "weekly",
  "dayOfWeek": "friday",

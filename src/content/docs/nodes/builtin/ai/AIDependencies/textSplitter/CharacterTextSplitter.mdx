...
Character Text Splitter belongs to the **Text Splitter** palette group. Its canonical node id is `characterTextSplitter` and its source documentation link is `/nodes/builtin/ai/aidependencies/textsplitter/charactertextsplitter/`.

## When to use it

Use Character Text Splitter as part of an AI workflow, either as an agent node or as a dependency connected to an agent.

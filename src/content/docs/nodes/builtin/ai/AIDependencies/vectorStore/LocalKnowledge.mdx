...
<Tabs>
  <TabItem label="Creating Database">
    <Code
      code={`{
  "database_name": "renewable_energy_research",
  "action": "create",
  ...
  <TabItem label="Adding Documents">
    <Code
      code={`{
  "database_name": "renewable_energy_research",
  "action": "insert",
  "document": {
    ...
    "content": "Recent advances in photovoltaic technology have increased solar panel efficiency to 22.8%. This study examines the impact of new materials...",
    "metadata": {
      "source": "Journal of Renewable Energy",
      "date": "2024-01-15",
      "category": "solar"
    }
  }
  ...
  <TabItem label="Searching Documents">
    <Code
      code={`{
  "database_name": "renewable_energy_research",
  "action": "search",
  "query": {
    "text": "What are the latest improvements in solar technology?",
    "max_results": 5,

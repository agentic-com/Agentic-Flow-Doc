...
### 🚀 Ready for More?
- Explore [RAG Node](/nodes/builtin/ai/AIAgents/RAGNode) for intelligent document search
- Try [Ollama Embeddings](/nodes/builtin/ai/AIDependencies/embeddings/OllamaEmbeddings) for creating document vectors

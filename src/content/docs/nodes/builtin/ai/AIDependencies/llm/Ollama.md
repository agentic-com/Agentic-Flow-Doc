...
### 🚀 Ready for More?
- Explore [Basic LLM Chain](/nodes/builtin/ai/AIAgents/BasicLLMChainNode) to use Ollama in workflows
- Try [RAG Node](/nodes/builtin/ai/AIAgents/RAGNode) for document-based AI

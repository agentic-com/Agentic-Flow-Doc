...
<Tabs>
  <TabItem label="Basic Setup">
    <Code
      code={`{
  "prompt": "Summarize this article in 3 key bullet points",
  "temperature": 0.3,
  "maxTokens": 300
}`}
      lang="json"
  ...
  <TabItem label="Information Extraction">
    <Code
      code={`{
  "prompt": "Extract the title, main topic, and key findings from this content",
  "temperature": 0.1,
  "maxTokens": 500
}`}
      lang="json"
  ...
  <TabItem label="Content Generation">
    <Code
      code={`{
  "prompt": "Create a social media post based on this article content",
  "temperature": 0.7,
  "maxTokens": 200
}`}
      lang="json"

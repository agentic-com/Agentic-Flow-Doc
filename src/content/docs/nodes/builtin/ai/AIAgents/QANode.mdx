...
<Tabs>
  <TabItem label="Extract Key Info">
    <Code
      code={`{
  ...
  <TabItem label="Find Problems">
    <Code
      code={`{
  "question": "What complaints do customers have about this product?",
  "confidenceThreshold": 0.7,
  "answerStyle": "bullet-points"
}`}
      lang="json"
    />
  </TabItem>
  <TabItem label="Compare Features">
    <Code
      code={`{
  "question": "How does this product compare to competitors mentioned in the review?",
  "confidenceThreshold": 0.8,
  "maxAnswerLength": 500
}`}
      lang="json"

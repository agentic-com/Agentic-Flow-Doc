...
Q&A Agent belongs to the **AI Agents** palette group. Its canonical node id is `qaAgent` and its source documentation link is `/nodes/builtin/ai/aiagents/qanode/`.

## When to use it

Use Q&A Agent as part of an AI workflow, either as an agent node or as a dependency connected to an agent.

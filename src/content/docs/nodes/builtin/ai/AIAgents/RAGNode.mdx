...
RAG Agent belongs to the **AI Agents** palette group. Its canonical node id is `ragAgent` and its source documentation link is `/nodes/builtin/ai/aiagents/ragnode/`.

## When to use it

Use RAG Agent as part of an AI workflow, either as an agent node or as a dependency connected to an agent.

...
<Tabs>
  <TabItem label="Research Task">
    <Code
      code={`{
  "taskDescription": "Visit 3 competitor websites and extract their pricing information",
  "availableTools": ["GetAllTextFromLink", "BasicLLMChain", "EditFields"],
  "maxIterations": 8
}`}
      lang="json"
    />
  </TabItem>
  <TabItem label="Data Collection">
    <Code
      code={`{
  "taskDescription": "Extract contact information from tech company websites",
  "availableTools": ["GetHTMLFromLink", "EditFields", "Filter"],
  "maxIterations": 6
}`}
      lang="json"
    />
  </TabItem>
  <TabItem label="Content Analysis">
    <Code
      code={`{
  "taskDescription": "Analyze product reviews and summarize key insights",
  "availableTools": ["GetAllTextFromLink", "BasicLLMChain", "QANode"],
  "maxIterations": 10
}`}
      lang="json"
    />

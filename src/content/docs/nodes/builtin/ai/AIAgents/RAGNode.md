...
Start with [Local Knowledge](/nodes/builtin/ai/AIDependencies/vectorStore/LocalKnowledge) to build your first document collection

### 🚀 Ready for More?
- Try [Q&A Node](/nodes/builtin/ai/AIAgents/QANode) for simpler question-answering

...
- It can't be used as the memory of a [Chat Trigger](/nodes/builtin/trigger/chat/): nothing is saved, so the chat window has no conversation to show. Use Local Memory or Persistent Chat Memory instead.

...
Provides access to Anthropic's Claude models for AI agent nodes.

## When to use it

Connect this to AI agents when you want to use Claude models for their strong reasoning and analysis capabilities.

...
The Subtract From A Date node provides comprehensive date arithmetic capabilities for subtracting various time periods from existing dates. This node handles complex date calculations including timezone conversions, business day arithmetic, and flexible time unit operations, making it essential for deadline calculations, historical analysis, and temporal workflow automation.
...
- **Multiple Date Formats**: Accept and output dates in various standard formats

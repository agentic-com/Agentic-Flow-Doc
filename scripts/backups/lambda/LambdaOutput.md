---
title: Lambda Output
description: "Define output structure and data flow for modular lambda workflows in Agentic Flow automation."
template: doc
...
- **Prevention**: Test output schemas with various processing scenarios during development
